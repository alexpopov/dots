return {
...

  {
    ...
    keys = {
      ...
      { "<Leader>fr", ":Telescope registers<CR>", desc = "Clipboard/Registers" },
      { "<Leader>fh", ":Telescope current_buffer_fuzzy_find<CR>", desc = "Find Here (in this file)" },
      {
        "<Leader>fl",
        function()
          require("telescope.builtin").grep_string({ shorten_path = true, grep_open_files = true, word_match = "-w", only_sort_text = true, search = "" })
        end,
        desc = "Find Line (in open files)",
      },
      {
        "<Leader>fm",
        function()
          require("telescope.builtin").builtin(require("telescope.themes").get_dropdown({ preview = false }))
        end,
